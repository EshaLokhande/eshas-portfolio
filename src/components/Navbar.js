        ...
        <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md shadow-md">
            ...
            <div className="flex items-center justify-between max-w-5xl mx-auto px-6 py-4 ">
                ...
                <div className=" hidden sm:flex gap-8">
                    <Link href="/" className="font-medium text-gray-700 transition hover:text-purple-600">Home</Link>

                    <Link href="/about" className="font-medium text-gray-700 transition hover:text-purple-600">About</Link>

                    <Link href="/skills" className="font-medium text-gray-700 transition hover:text-purple-600">Skills</Link>

                    <Link href="/projects" className="font-medium text-gray-700 transition hover:text-purple-600">Projects</Link>

                    <Link href="/contact" className="font-medium text-gray-700 transition hover:text-purple-600">Contact</Link>
